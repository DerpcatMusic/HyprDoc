...
import { 
    ...
    Moon, Sun, Book, Package, Hexagon, LogOut, Menu, X, SlidersHorizontal, GripVertical
} from 'lucide-react';
...
const useResizable = (initialWidth: number, minWidth: number, maxWidth: number, direction: 'right' | 'left') => {
